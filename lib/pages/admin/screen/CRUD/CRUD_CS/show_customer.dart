...
class ShowAccountCs extends StatefulWidget {
  const ShowAccountCs({Key? key}) : super(key: key);
...
class _ShowAccountCsState extends State<ShowAccountCs> {
          ...
          SliverAppBar(
            ...
            title: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, AppRoute.addccountecs);
                  },
                  child: AppIcon(
                    icon: Icons.add,
                    iconSize: 24,
  ...
  Future<Null> readAccount() async {
    ...
    String url = '${API().BASE_URL}/rattaphumwater/readaccountCs.php?isAdd=true&ChooseType=Customer';
