...
class AddAccountCs extends StatefulWidget {
  const AddAccountCs({Key? key}) : super(key: key);

  @override
  State<AddAccountCs> createState() => _AddAccountCsState();
}

class _AddAccountCsState extends State<AddAccountCs> {
  bool isHidden = false;
